...
public class VarDeclarationUnordered implements Node {
   private Node parent;
   public Type f0;
   ...
   public VarDeclarationUnordered(Type n0, Identifier n1, NodeToken n2) {
      f0 = n0;
   ...
   public VarDeclarationUnordered(Type n0, Identifier n1) {
      f0 = n0;
      if ( f0 != null ) f0.setParent(this);
      f1 = n1;
      if ( f1 != null ) f1.setParent(this);
