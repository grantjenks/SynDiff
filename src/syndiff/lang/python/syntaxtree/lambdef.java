...
public class lambdef implements Node {
   private Node parent;
   public NodeToken f0;
   ...
   public lambdef(NodeToken n0, NodeOptional n1, NodeToken n2, test n3) {
      f0 = n0;
   ...
   public lambdef(NodeOptional n0, test n1) {
      f0 = new NodeToken("lambda");
      if ( f0 != null ) f0.setParent(this);
      f1 = n0;
      if ( f1 != null ) f1.setParent(this);
      f2 = new NodeToken(":");
