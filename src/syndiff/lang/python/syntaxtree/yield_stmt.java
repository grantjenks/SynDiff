...
public class yield_stmt implements Node {
   private Node parent;
   public NodeToken f0;
   public SmartTestList f1;
   private ArrayList<Node> subNodes = new ArrayList<Node>();

   public yield_stmt(NodeToken n0, SmartTestList n1) {
      f0 = n0;
   ...
   public yield_stmt(SmartTestList n0) {
      f0 = new NodeToken("yield");
      if ( f0 != null ) f0.setParent(this);
      f1 = n0;
      if ( f1 != null ) f1.setParent(this);
