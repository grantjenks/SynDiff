...
public class for_stmt implements Node {
   private Node parent;
   public NodeToken f0;
   public exprlist f1;
   public NodeToken f2;
   ...
   public for_stmt(NodeToken n0, exprlist n1, NodeToken n2, SmartTestList n3, NodeToken n4, suite n5, NodeOptional n6) {
      f0 = n0;
   ...
   public for_stmt(exprlist n0, SmartTestList n1, suite n2, NodeOptional n3) {
