...
/**
 * Grammar production:
 * f0 -> defaultarg() ( <COMMA> defaultarg() )* [ <COMMA> ExtraArgList() ] [ <COMMA> ExtraKeywordList() ] [ <COMMA> ]
 *       | ( ExtraArgList() [ <COMMA> ExtraKeywordList() ] | ExtraKeywordList() )
 */
import java.util.*;
import lang.syntaxtree.*;
public class varargslist implements Node {
   private Node parent;
   public NodeChoice f0;
   private ArrayList<Node> subNodes = new ArrayList<Node>();

   public varargslist(NodeChoice n0) {
      f0 = n0;
