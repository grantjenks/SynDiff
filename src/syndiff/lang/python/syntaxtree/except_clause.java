...
public class except_clause implements Node {
   private Node parent;
   public NodeToken f0;
   ...
   public except_clause(NodeToken n0, NodeOptional n1, NodeToken n2, suite n3) {
      f0 = n0;
   ...
   public except_clause(NodeOptional n0, suite n1) {
      f0 = new NodeToken("except");
      if ( f0 != null ) f0.setParent(this);
      f1 = n0;
      if ( f1 != null ) f1.setParent(this);
      f2 = new NodeToken(":");
