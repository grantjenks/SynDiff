 ...
 * f0 -> <EXEC>
 * f1 -> expr()
 * f2 -> [ <IN> test() [ <COMMA> test() ] ]
 */
import java.util.*;
import lang.syntaxtree.*;
public class exec_stmt implements Node {
   private Node parent;
   public NodeToken f0;
   public expr f1;
   ...
   public exec_stmt(NodeToken n0, expr n1, NodeOptional n2) {
      f0 = n0;
   ...
   public exec_stmt(expr n0, NodeOptional n1) {
