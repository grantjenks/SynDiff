 ...
 * Grammar production:
 * f0 -> small_stmt()
 * f1 -> ( <SEMICOLON> small_stmt() )*
 * f2 -> [ <SEMICOLON> ]
 * f3 -> <NEWLINE>
 */
import java.util.*;
import lang.syntaxtree.*;
public class simple_stmt implements Node {
   private Node parent;
   public small_stmt f0;
   public NodeListOptional f1;
   public NodeOptional f2;
   public NodeToken f3;
   private ArrayList<Node> subNodes = new ArrayList<Node>();

   public simple_stmt(small_stmt n0, NodeListOptional n1, NodeOptional n2, NodeToken n3) {
      f0 = n0;
