 ...
 * Grammar production:
 * f0 -> SmartTestList()
 * f1 -> ( <PLUSEQ> SmartTestList() | <MINUSEQ> SmartTestList() | <MULTIPLYEQ> SmartTestList() | <DIVIDEEQ> SmartTestList() | <FLOORDIVIDEEQ> SmartTestList() | <MODULOEQ> SmartTestList() | <ANDEQ> SmartTestList() | <OREQ> SmartTestList() | <XOREQ> SmartTestList() | <LSHIFTEQ> SmartTestList() | <RSHIFTEQ> SmartTestList() | <POWEREQ> SmartTestList() | ( <EQUAL> SmartTestList() )* )
 */
import java.util.*;
import lang.syntaxtree.*;
public class expr_stmt implements Node {
   private Node parent;
   public SmartTestList f0;
   public NodeChoice f1;
   private ArrayList<Node> subNodes = new ArrayList<Node>();

   public expr_stmt(SmartTestList n0, NodeChoice n1) {
      f0 = n0;
