...
public class global_stmt implements Node {
   private Node parent;
   public NodeToken f0;
   public Name f1;
   ...
   public global_stmt(NodeToken n0, Name n1, NodeListOptional n2) {
      f0 = n0;
   ...
   public global_stmt(Name n0, NodeListOptional n1) {
      f0 = new NodeToken("global");
      if ( f0 != null ) f0.setParent(this);
      f1 = n0;
      if ( f1 != null ) f1.setParent(this);
      f2 = n1;
