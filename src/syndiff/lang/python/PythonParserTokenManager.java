   ...
   for (;;)
   {
      ...
      else
      {
         ...
         MatchLoop: do
         {
            ...
            {
               case 0:
                  if ((jjbitVec0[i2] & l2) != 0L && kind > 133)
                     kind = 133;
                  break;
               case 2:
                  if ((jjbitVec0[i2] & l2) != 0L && kind > 134)
                     kind = 134;
                  break;
               default : break;
            }
   ...
   for (;;)
   {
      ...
      else
      {
         ...
         MatchLoop: do
         {
            ...
            {
               case 0:
                  if ((jjbitVec0[i2] & l2) != 0L && kind > 128)
                     kind = 128;
                  break;
               default : break;
            }
   ...
   for (;;)
   {
      ...
      else
      {
         ...
         MatchLoop: do
         {
            ...
            {
               case 0:
                  if ((jjbitVec0[i2] & l2) != 0L && kind > 129)
                     kind = 129;
                  break;
               default : break;
            }
...
public PythonParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public PythonParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
