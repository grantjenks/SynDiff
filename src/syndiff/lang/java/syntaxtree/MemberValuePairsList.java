...
/**
 * Grammar production:
 * f0 -> "," MemberValuePair() MemberValuePairsList()
 *       | EndMemberValuePairsList()
 */
import java.util.*;
import lang.syntaxtree.*;
public class MemberValuePairsList implements Node {
   private Node parent;
   public NodeChoice f0;
   private ArrayList<Node> subNodes = new ArrayList<Node>();

   public MemberValuePairsList(NodeChoice n0) {
      f0 = n0;
