...
/**
 * Grammar production:
 * f0 -> "," MemberValue() MemberValueArrayInitializerList()
 *       | EndMemberValueArrayInitializerList()
 */
import java.util.*;
import lang.syntaxtree.*;
public class MemberValueArrayInitializerList implements Node {
   private Node parent;
   public NodeChoice f0;
   private ArrayList<Node> subNodes = new ArrayList<Node>();

   public MemberValueArrayInitializerList(NodeChoice n0) {
      f0 = n0;
