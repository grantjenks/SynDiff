...
public class JavaParser implements JavaParserConstants {
  ...
  final public CompilationUnit CompilationUnit() throws ParseException {
   ...
   ImportDeclarationUnordered n3;
   NodeListOptional n4 = new NodeListOptional();
   TypeDeclarationUnordered n5;
  ...
  final public ImportDeclarationUnordered ImportDeclarationUnordered() throws ParseException {
   NodeToken n0;
   Token n1;
   ...
   Token n13;
    ...
    n13 = jj_consume_token(SEMICOLON);
             n12 = JTBToolkit.makeNodeToken(n13);
     {if (true) return new ImportDeclarationUnordered(n0,n2,n5,n6,n12);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public EnumBody EnumBody() throws ParseException {
   ...
   ClassOrInterfaceBodyDeclarationUnordered n18;
   NodeToken n19;
   Token n20;
    ...
    case SEMICOLON:
      ...
      while (true) {
        ...
        n18 = ClassOrInterfaceBodyDeclarationUnordered();
           n17.addNode(n18);
      }
  ...
  final public ClassOrInterfaceBody ClassOrInterfaceBody() throws ParseException {
   ...
   Token n1;
   NodeListOptional n2 = new NodeListOptional();
   ClassOrInterfaceBodyDeclarationUnordered n3;
   NodeToken n4;
   Token n5;
    n1 = jj_consume_token(LBRACE);
            n0 = JTBToolkit.makeNodeToken(n1);
    ...
    while (true) {
      ...
      n3 = ClassOrInterfaceBodyDeclarationUnordered();
        n2.addNode(n3);
    }
     n2.nodes.trimToSize();
  ...
  final public ClassOrInterfaceBodyDeclarationUnordered ClassOrInterfaceBodyDeclarationUnordered() throws ParseException {
   NodeChoice n0;
   Initializer n1;
   NodeSequence n2;
   Modifiers n3;
   ...
   Token n11;
    if (jj_2_6(2)) {
     ...
     {if (true) return new ClassOrInterfaceBodyDeclarationUnordered(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Block Block() throws ParseException {
   NodeToken n0;
   Token n1;
   BlockStatementList n2;
   NodeToken n3;
   Token n4;
    n1 = jj_consume_token(LBRACE);
            n0 = JTBToolkit.makeNodeToken(n1);
    n2 = BlockStatementList();
  ...
  final public BlockStatementList BlockStatementList() throws ParseException {
   NodeChoice n0;
   NodeSequence n1;
   BlockStatement n2;
   BlockStatementList n3;
   EndBlockStatement n4;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABSTRACT:
    case ASSERT:
    case BOOLEAN:
    ...
    case DECR:
      ...
      n2 = BlockStatement();
        n1.addNode(n2);
      n3 = BlockStatementList();
        n1.addNode(n3);
        n0 = new NodeChoice(n1, 0);
      break;
    default:
      n4 = EndBlockStatement();
        n0 = new NodeChoice(n4, 1);
    }
     {if (true) return new BlockStatementList(n0);}
    throw new Error("Missing return statement in function");
  }

  final public EndBlockStatement EndBlockStatement() throws ParseException {
     {if (true) return new EndBlockStatement();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public StatementExpressionList StatementExpressionList() throws ParseException {
   ...
   StatementExpressionListList n1;
    n0 = StatementExpression();
    n1 = StatementExpressionListList();
     {if (true) return new StatementExpressionList(n0,n1);}
    throw new Error("Missing return statement in function");
  }

  final public StatementExpressionListList StatementExpressionListList() throws ParseException {
   NodeChoice n0;
   NodeSequence n1;
   NodeToken n2;
   Token n3;
   StatementExpression n4;
   StatementExpressionListList n5;
   EndStatementExpressionListList n6;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
        n1 = new NodeSequence(3);
      ...
      n4 = StatementExpression();
        n1.addNode(n4);
      n5 = StatementExpressionListList();
        n1.addNode(n5);
        n0 = new NodeChoice(n1, 0);
      break;
    default:
      n6 = EndStatementExpressionListList();
        n0 = new NodeChoice(n6, 1);
    }
     {if (true) return new StatementExpressionListList(n0);}
    throw new Error("Missing return statement in function");
  }

  final public EndStatementExpressionListList EndStatementExpressionListList() throws ParseException {
     {if (true) return new EndStatementExpressionListList();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public TryStatement TryStatement() throws ParseException {
   ...
   Block n8;
    ...
    default:
     ...
     {if (true) return new TryStatement(n0,n2,n3,n4);}
    throw new Error("Missing return statement in function");
  }

  final public TryStatementList TryStatementList() throws ParseException {
   NodeChoice n0;
   NodeSequence n1;
   NodeToken n2;
   Token n3;
   ...
   Token n8;
   Block n9;
   TryStatementList n10;
   EndTryStatementList n11;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CATCH:
        n1 = new NodeSequence(6);
      n3 = jj_consume_token(CATCH);
                   n2 = JTBToolkit.makeNodeToken(n3);
        n1.addNode(n2);
      ...
      n9 = Block();
        n1.addNode(n9);
      n10 = TryStatementList();
        n1.addNode(n10);
        n0 = new NodeChoice(n1, 0);
      break;
    default:
      n11 = EndTryStatementList();
        n0 = new NodeChoice(n11, 1);
    }
     {if (true) return new TryStatementList(n0);}
    throw new Error("Missing return statement in function");
  }

  final public EndTryStatementList EndTryStatementList() throws ParseException {
     {if (true) return new EndTryStatementList();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public MemberValuePairs MemberValuePairs() throws ParseException {
   MemberValuePair n0;
   MemberValuePairsList n1;
    n0 = MemberValuePair();
    n1 = MemberValuePairsList();
     {if (true) return new MemberValuePairs(n0,n1);}
    throw new Error("Missing return statement in function");
  }

  final public MemberValuePairsList MemberValuePairsList() throws ParseException {
   NodeChoice n0;
   NodeSequence n1;
   NodeToken n2;
   Token n3;
   MemberValuePair n4;
   MemberValuePairsList n5;
   EndMemberValuePairsList n6;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
        n1 = new NodeSequence(3);
      n3 = jj_consume_token(COMMA);
      ...
      n4 = MemberValuePair();
        n1.addNode(n4);
      n5 = MemberValuePairsList();
        n1.addNode(n5);
        n0 = new NodeChoice(n1, 0);
      break;
    default:
      n6 = EndMemberValuePairsList();
        n0 = new NodeChoice(n6, 1);
    }
     {if (true) return new MemberValuePairsList(n0);}
    throw new Error("Missing return statement in function");
  }

  final public EndMemberValuePairsList EndMemberValuePairsList() throws ParseException {
     {if (true) return new EndMemberValuePairsList();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public MemberValueArrayInitializer MemberValueArrayInitializer() throws ParseException {
   ...
   Token n1;
   MemberValue n2;
   MemberValueArrayInitializerList n3;
   NodeOptional n4 = new NodeOptional();
   NodeToken n5;
   Token n6;
   NodeToken n7;
   Token n8;
    n1 = jj_consume_token(LBRACE);
            n0 = JTBToolkit.makeNodeToken(n1);
    n2 = MemberValue();
    n3 = MemberValueArrayInitializerList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
      n6 = jj_consume_token(COMMA);
               n5 = JTBToolkit.makeNodeToken(n6);
    ...
    n8 = jj_consume_token(RBRACE);
            n7 = JTBToolkit.makeNodeToken(n8);
     {if (true) return new MemberValueArrayInitializer(n0,n2,n3,n4,n7);}
    throw new Error("Missing return statement in function");
  }

  final public MemberValueArrayInitializerList MemberValueArrayInitializerList() throws ParseException {
   NodeChoice n0;
   NodeSequence n1;
   NodeToken n2;
   Token n3;
   MemberValue n4;
   MemberValueArrayInitializerList n5;
   EndMemberValueArrayInitializerList n6;
    if (jj_2_42(2)) {
        n1 = new NodeSequence(4);
      n3 = jj_consume_token(COMMA);
               n2 = JTBToolkit.makeNodeToken(n3);
      ...
      n4 = MemberValue();
        n1.addNode(n4);
      n5 = MemberValueArrayInitializerList();
        n1.addNode(n5);
        n0 = new NodeChoice(n1, 0);
    } else {
      n6 = EndMemberValueArrayInitializerList();
        n0 = new NodeChoice(n6, 1);
    }
     {if (true) return new MemberValueArrayInitializerList(n0);}
    throw new Error("Missing return statement in function");
  }

  final public EndMemberValueArrayInitializerList EndMemberValueArrayInitializerList() throws ParseException {
     {if (true) return new EndMemberValueArrayInitializerList();}
    throw new Error("Missing return statement in function");
  }
